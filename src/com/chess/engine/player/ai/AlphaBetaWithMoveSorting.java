...
public class AlphaBetaWithMoveSorting extends Observable implements MoveStrategy {
        ...
        public static final Comparator<Move> SMART_SORT = new Comparator<Move>() {
            ...
            public int compare(final Move move1, final Move move2) {
                return ComparisonChain.start()
                        ...
                        .compare(move2.getPieceMoved().getPieceValue(), move1.getPieceMoved().getPieceValue())
                        .result();
            }
        };
    ...
    public AlphaBetaWithMoveSorting(final int maxSearchTime) {
    ...
    public Move execute(Board board) {
        // TODO: implement search time thingy
        ...
        for (final Move move : this.moveSorter.sort(board.currentPlayer().getLegalMoves())) {
            ...
            if (moveTransition.getMoveStatus().isDone()) {
                ...
                s = "\t" + toString() + "(" +this.searchDepth+ "), m: (" + moveCounter + "/" + numMoves + ") " +
                        move + ", best:  " + bestMove + quiescenceInfo + ", t: " +
